                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="container">
                                                <div class="row justify-content-center">
                                                  <div>
                                                    <a href="/projects/{{$row->project_ref}}" class="btn btn-success btn-sm" tabindex="-1" role="button" aria-disabled="true">Show</a>
                                                  </div>
                                                  <div>
                                                    <a href="/projects/{{$row->project_ref}}/edit" class="btn btn-warning btn-sm" tabindex="-1" role="button" aria-disabled="true">Update</a>
                                                  </div>
                                                  <div>
                                                    {!! Form::open(['action' => ['ProjectsController@destroy', $row->project_ref], 'method' => 'POST']) !!}
